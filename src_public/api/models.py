...
These models match the production API schemas exactly.
"""
...
class RAGUsedContext(BaseModel):
    """Context information about items used in the response."""
...
class FeedbackRequest(BaseModel):
    ...
    feedback_score: Union[int, None] = Field(..., description="1 if positive, 0 if negative, null if neutral")
